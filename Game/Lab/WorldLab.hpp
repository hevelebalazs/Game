...
static void func WorldLabResize (WorldLabState* labState, I32 width, I32 height)
{
	Bitmap* bitmap = &labState->canvas.bitmap;
	ResizeBitmap (bitmap, width, height);
}

static F32 func SmoothRatio (F32 x)
{
	F32 result = x * x * (3.0f - 2.0f * x);
	return result;
}

static F32 func GetRandomValueFromTable (WorldLabState* labState, I32 index)
{
	Assert (index >= 0);
...
static F32 func GetGridPointValue (WorldLabState* labState, I32 gridLevel, I32 row, I32 col)
{
...
static F32 func GetPointValue (WorldLabState* labState, I32 gridLevel, F32 x, F32 y)
{
	I32 gridN = (1 << gridLevel);
...
static void func GenerateGridBitmap (WorldLabState* labState, I32 gridLevel, I32 row, I32 col, Bitmap* bitmap)
{
...
static void func LoadGridBitmap (WorldLabState* labState, I32 row, I32 col)
{
...
static void func WorldLabInit (WorldLabState* labState, I32 width, I32 height)
{
	InitRandom ();
...
static void func WorldLabUpdate (WorldLabState* labState, V2 mouse)
{
	Bitmap* bitmap = &labState->canvas.bitmap;
