...
inline Bezier4 TurnBezier4(DirectedPoint startPoint, DirectedPoint endPoint) {
	Bezier4 result = {};
...
inline Point Bezier4Interpolation(Point point1, float ratio1, Point point2, float ratio2) {
...
inline Point Bezier4Point(Bezier4 bezier4, float ratio) {
...
inline DirectedPoint Bezier4DirectedPoint(Bezier4 bezier4, float ratio) {
	float ratio2 = (1.0f - ratio);
...
inline void DrawBezier4(Renderer renderer, Bezier4 bezier4, Color color, float lineWidth, int segmentCount) {
